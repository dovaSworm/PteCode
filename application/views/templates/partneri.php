    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" role="listbox">
        <div class="partner-holder">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="" src="<?php echo base_url(); ?>assets/img/smt2.png" alt="Third slide">
                </div>
                <div class="carousel-item">
                    <img class="" src="<?php echo base_url(); ?>assets/img/pakt.png" alt="Third slide">
                </div>
            </div>
        </div>
        <div class="row no-gutters text-center tech-supp">
            <p class="text-center m-auto"><b>Partner i tehnička podrška za automatske sisteme za SMD montažu</b><br><a href="https://npiflux.rs">New Product Implementation, Beograd</a></p>
        </div>
    </div><!-- PARTNERS end -->
</div>
</section>
