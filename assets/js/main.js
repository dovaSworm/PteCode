$(function() {
    ...
    var shrinkNavbar = function() {
        setTimeout(function() {
            ...
            setTimeout(function() {
                ...
                $(".navbar h2").css({ "display": "block", "margin-top": "10px", "margin-right": "71px", "color": "rgb(47, 187, 230)" });
            }, 1200);
        }, 3400);
    }
    ...
    // EFFECTS navbar    --------------------------------------------------------------------
    if (document.title === "Pro-technology Electronics sistemi za PCB montažu,lemilice,antistaički") {
